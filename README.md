...
- 2025年: pmmp界隈およびdq9界隈の双方で活動(PHP+ARMV5T)
...
## 私は、生成AI許容派です。
- 生成AIによってプログラミングをすることは、人が正しくレビュー、動作確認すれば問題ないという思考を持っており、Vibe Codingしてツールを作るなどもしています。
- ただし、生成AIは万能な存在と思っておらず、初歩的なミスをすることに対して苦言を言うことがあります。
