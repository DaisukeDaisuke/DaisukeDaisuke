...
- Githubで使用しているもの: 当時のAndroidのペイントアプリで手書き、自作したアイコンです。ドット絵手書きであるため、つじつまが合わず段差があります。元データはクラウドで保持しています。  
- Disocrdで使用しているもの: 同じデザインのアイコンに、違和感のある影が付いたものです。上記ドット絵より高解像度です。これもペイントアプリで自作したため、私が著作権を持ちます。これも高画質元データをクラウドで保持しています。  
...
- Steamって何？
- ツイッターのLTはVRChatのかわいい写真が流れてくるように調教してます。
