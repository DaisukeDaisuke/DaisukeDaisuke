...
- 常用漢字程度であればかなりの速度で意味を理解することができます。
  ...
  - 読書はしません。主にネットニュース(稀)や技術文書などを主に読んでおり、長文だとワーキングメモリからあふれて要約しか残らないし、基礎知識に収録されてなくて読めない、読み方は知らないけどグループ読みの対象で知ってるとか、初見で形状読みが拒否するなどの字とかもあります。多分物語に対する理解の能力があまりないからだと思います。
